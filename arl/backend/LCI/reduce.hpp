...
struct reduce_mpi_ty_id<T,
    /*is_integral=*/true,
    /*is_floating=*/false
>: reduce_mpi_ty_id_integral</*bits=*/8*sizeof(T), std::is_signed<T>::value> {
};
...
struct reduce_mpi_ty_id<T,
    /*is_integral=*/false,
    /*is_floating=*/true
>: reduce_mpi_ty_id_floating</*bits=*/8*sizeof(T)> {
};
...
template<> const MPI_Datatype reduce_mpi_ty_id_integral<32, /*signed=*/true>::ty_id = MPI_INT32_T;
template<> const MPI_Datatype reduce_mpi_ty_id_integral<64, /*signed=*/true>::ty_id = MPI_INT64_T;
template<> const MPI_Datatype reduce_mpi_ty_id_integral<32, /*signed=*/false>::ty_id = MPI_UINT32_T;
template<> const MPI_Datatype reduce_mpi_ty_id_integral<64, /*signed=*/false>::ty_id = MPI_UINT64_T;
template<> const MPI_Datatype reduce_mpi_ty_id_floating<32>::ty_id = MPI_FLOAT;
template<> const MPI_Datatype reduce_mpi_ty_id_floating<64>::ty_id = MPI_DOUBLE;

template<> const MPI_Op reduce_mpi_op_id<op_plus>::op_id = MPI_SUM;
template<> const MPI_Op reduce_mpi_op_id<op_multiplies>::op_id = MPI_PROD;
template<> const MPI_Op reduce_mpi_op_id<op_min>::op_id = MPI_MIN;
template<> const MPI_Op reduce_mpi_op_id<op_max>::op_id = MPI_MAX;
template<> const MPI_Op reduce_mpi_op_id<op_bit_and>::op_id = MPI_BAND;
template<> const MPI_Op reduce_mpi_op_id<op_bit_or>::op_id = MPI_BOR;
template<> const MPI_Op reduce_mpi_op_id<op_bit_xor>::op_id = MPI_BXOR;
