...
struct reduce_gex_ty_id<T,
    /*is_integral=*/true,
    /*is_floating=*/false
>: reduce_gex_ty_id_integral</*bits=*/8*sizeof(T), std::is_signed<T>::value> {
};
...
struct reduce_gex_ty_id<T,
    /*is_integral=*/false,
    /*is_floating=*/true
>: reduce_gex_ty_id_floating</*bits=*/8*sizeof(T)> {
};
...
template<> const gex_DT_t reduce_gex_ty_id_integral<32, /*signed=*/true>::ty_id = GEX_DT_I32;
template<> const gex_DT_t reduce_gex_ty_id_integral<64, /*signed=*/true>::ty_id = GEX_DT_I64;
template<> const gex_DT_t reduce_gex_ty_id_integral<32, /*signed=*/false>::ty_id = GEX_DT_U32;
template<> const gex_DT_t reduce_gex_ty_id_integral<64, /*signed=*/false>::ty_id = GEX_DT_U64;
template<> const gex_DT_t reduce_gex_ty_id_floating<32>::ty_id = GEX_DT_FLT;
template<> const gex_DT_t reduce_gex_ty_id_floating<64>::ty_id = GEX_DT_DBL;

template<> const gex_OP_t reduce_gex_op_id<op_plus>::op_id = GEX_OP_ADD;
template<> const gex_OP_t reduce_gex_op_id<op_multiplies>::op_id = GEX_OP_MULT;
template<> const gex_OP_t reduce_gex_op_id<op_min>::op_id = GEX_OP_MIN;
template<> const gex_OP_t reduce_gex_op_id<op_max>::op_id = GEX_OP_MAX;
template<> const gex_OP_t reduce_gex_op_id<op_bit_and>::op_id = GEX_OP_AND;
template<> const gex_OP_t reduce_gex_op_id<op_bit_or>::op_id = GEX_OP_OR;
template<> const gex_OP_t reduce_gex_op_id<op_bit_xor>::op_id = GEX_OP_XOR;
